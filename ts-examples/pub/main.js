...
var bookDetails = /** @class */ (function () {
    function bookDetails(_isbn, _bookName, _author, _price) {
        this._isbn = _isbn;
...
var obj1 = new bookDetails("INDJAVA5475", "let us JAVA", "JAMES GOSLING", 550);
var obj2 = new bookDetails("INDIAC45475", "let us C", "Dennis Ritchie", 550);
var obj3 = new bookDetails("INDPYTHON75", "let us PYTHON", "GUIDO VAN RUSSOM", 550);
var obj4 = new bookDetails("INDPHP45475", "let us PHP", "RASMUS Lerdorf", 550);
